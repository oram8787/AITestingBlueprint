...
Four cards (`Load PDF → Chunk → Embed (Nomic) → Store (ChromaDB)`) light up
with real stats — page count, chunk count, embedding dimensions, and how
many milliseconds each stage took.
